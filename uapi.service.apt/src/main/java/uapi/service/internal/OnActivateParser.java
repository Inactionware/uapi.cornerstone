...
public class OnActivateParser {
    ...
    class OnActivateHelper {
        ...
        public void addActivateMethod(
            ...
            var tempActivateModel = classBuilder.createTransienceIfAbsent(MODEL_ON_ACTIVATE, HashMap::new);
            var existingMethods = tempActivateModel.get(VAR_METHODS);
            List<String> methods;
            ...
            var methodBuilders = classBuilder.findMethodBuilders(METHOD_ON_ACTIVATE_NAME);
            ...
            var tempOnActivate = builderContext.loadTemplate(Module.name, TEMP_ON_ACTIVATE);
            classBuilder
